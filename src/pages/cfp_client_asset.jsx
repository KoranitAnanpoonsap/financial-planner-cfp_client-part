...
const SAMPLE_ASSETS = [
  {
    id: { clientId: 1, clientAssetName: "บัญชีออมทรัพย์" },
    clientAssetType: "สินทรัพย์สภาพคล่อง",
    clientAssetAmount: 90000,
    clientAssetBuyDate: null,
    clientAssetInvestType: null,
    clientAssetInvestRisk: null,
  },
  {
    id: { clientId: 1, clientAssetName: "บัญชีฝากประจำ" },
    clientAssetType: "สินทรัพย์สภาพคล่อง",
    clientAssetAmount: 200000,
    clientAssetBuyDate: null,
    clientAssetInvestType: null,
    clientAssetInvestRisk: null,
  },
  {
    id: { clientId: 1, clientAssetName: "รถยนต์" },
    clientAssetType: "สินทรัพย์ส่วนตัว",
    clientAssetAmount: 400000,
    clientAssetBuyDate: "2023-06-01",
    clientAssetInvestType: null,
    clientAssetInvestRisk: null,
  },
  {
    id: { clientId: 1, clientAssetName: "บ้าน" },
    clientAssetType: "สินทรัพย์ส่วนตัว",
    clientAssetAmount: 2500000,
    clientAssetBuyDate: "2021-06-01",
    clientAssetInvestType: null,
    clientAssetInvestRisk: null,
  },
  {
    id: { clientId: 1, clientAssetName: "หุ้น ABC" },
    clientAssetType: "สินทรัพย์ลงทุนปัจจุบัน",
    clientAssetAmount: 300000,
    clientAssetBuyDate: null,
    clientAssetInvestType: "หุ้นไทย",
    clientAssetInvestRisk: "เสี่ยงสูง",
  },
  {
    id: { clientId: 1, clientAssetName: "กองทุน RMF" },
    clientAssetType: "สินทรัพย์ลงทุนปัจจุบัน",
    clientAssetAmount: 400000,
    clientAssetBuyDate: null,
    clientAssetInvestType: "หุ้นกู้",
