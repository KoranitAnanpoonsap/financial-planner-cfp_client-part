...
const SAMPLE_DEBTS = [
  {
    id: {
      clientId: 1,
      clientDebtName: "หนี้บัตรเครดิต",
    },
    clientDebtType: "หนี้บัตรเครดิต",
    clientDebtTerm: "ระยะสั้น",
    clientDebtAmount: 20000,
    clientDebtAnnualInterest: 0,
    clientStartDateDebt: "2024-12-12",
    clientDebtDuration: 1,
    clientDebtPrincipal: 0,
  },
  {
    id: {
      clientId: 1,
      clientDebtName: "ผ่อนรถ (12 เดือน)",
    },
    clientDebtType: "หนี้รถยนต์",
    clientDebtTerm: "ระยะสั้น",
    clientDebtAmount: 96000,
    clientDebtAnnualInterest: 0.05,
    clientStartDateDebt: "2023-06-01",
    clientDebtDuration: 5,
    clientDebtPrincipal: 50000,
  },
  {
    id: {
      clientId: 1,
      clientDebtName: "ผ่อนบ้าน (12 เดือน)",
    },
    clientDebtType: "หนี้บ้าน",
    clientDebtTerm: "ระยะสั้น",
    clientDebtAmount: 192000,
    clientDebtAnnualInterest: 0.05,
    clientStartDateDebt: "2021-06-01",
    clientDebtDuration: 8,
    clientDebtPrincipal: 50000,
  },
  {
    id: {
      clientId: 1,
      clientDebtName: "ยอดคงค้างผ่อนรถ",
    },
    clientDebtType: "หนี้รถยนต์",
    clientDebtTerm: "ระยะยาว",
    clientDebtAmount: 224000,
    clientDebtAnnualInterest: 0.05,
    clientStartDateDebt: "2023-06-01",
    clientDebtDuration: 5,
    clientDebtPrincipal: 50000,
  },
  {
    id: {
      clientId: 1,
      clientDebtName: "ยอดคงค้างผ่อนบ้าน",
    },
    clientDebtType: "หนี้บ้าน",
    clientDebtTerm: "ระยะยาว",
    clientDebtAmount: 1728000,
    clientDebtAnnualInterest: 0.05,
    clientStartDateDebt: "2021-06-01",
    clientDebtDuration: 8,
    clientDebtPrincipal: 50000,
